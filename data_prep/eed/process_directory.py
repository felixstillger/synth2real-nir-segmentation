...
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '../../eed')))
...
def parse_args():
    ...
    parser.add_argument('--save_points', nargs='+', type=int, default=[512, 1024, 2048, 4096, 5792],
