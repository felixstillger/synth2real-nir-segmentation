_base_ = [
    ...
    '../_base_/datasets/ranus_8class.py', '../../mmsegmentation/configs/_base_/default_runtime.py',
...
# Explicit dataloaders for RGB training
train_dataloader = dict(
    ...
    dataset=dict(
        type='Ranus8ClassDataset',
        data_root='../../../data/Ranus_prepared',
        data_prefix=dict(
            img_path='RGB/train', seg_map_path='GT_8class/train'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='../../../data/Ranus_prepared',
        data_prefix=dict(
            img_path='RGB/val', seg_map_path='GT_8class/val'),
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='../../../data/Ranus_prepared',
        data_prefix=dict(
            img_path='RGB/test', seg_map_path='GT_8class/test'),
        pipeline=_base_.test_pipeline))

work_dir = './work_dirs/trainings/ranus/deeplabv3plus_r50-d8_4xb2-60k_ranus_8class_rgb'
